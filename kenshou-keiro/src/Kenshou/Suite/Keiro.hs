...
bundle :: LayerBundle
bundle = LayerBundle Keiro (Correctness.scenarios <> Concurrency.scenarios <> Projection.scenarios <> PMCorrectness.scenarios <> RouterCorrectness.scenarios) Roles.roles
