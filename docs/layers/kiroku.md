...
| `kiroku/subscription/correctness/catchup-live-handoff` | A 5,000-event prepopulation and paced appender run through twenty graceful restarts; native all-stream and category subscribers preserve coverage, order and monotonic checkpoints. Streamly API variants remain. |
