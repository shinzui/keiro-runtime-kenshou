...
- [ ] Complete `Kenshou.Suite.Shibuya.Matrix`: thirteen boundaries and five cases enumerate sixty-five cells; the seven registered scenarios have tested tags, while the remaining scenario tags, justified exclusions, and complete sixty-five-cell coverage assertion remain.
...
- [ ] Expand the registered bundle to all twenty-nine Milestone 1 scenarios and their roles; seven are registered now.
