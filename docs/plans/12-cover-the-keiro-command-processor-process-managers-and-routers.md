...
- [ ] Command correctness: `occ-retry-and-exhaustion`, `idempotent-event-ids`, and `controlled-rollback` pass, including retry exhaustion and the idempotency sabotage arm. `hydration-paging` remains.
