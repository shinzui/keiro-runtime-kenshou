...
- [ ] Implement `Kenshou.Suite.Kiroku.Knobs`, `.Fixture.Store`, `.Fixture.Telemetry`, `.Fixture.Workload`, `.Fixture.Facts`, `.Fixture.Oracle`, with unit tests. Knobs, store fixture and telemetry event-handler composition exist; the unit suite checks knob count, handler arm selection, unique scenario IDs and registry validation. Workload, fact and SQL oracle fixtures and their tests remain.
