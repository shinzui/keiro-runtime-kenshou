...
- [ ] Implement `Kenshou.Suite.Kiroku.Knobs`, `.Fixture.Store`, `.Fixture.Telemetry`, `.Fixture.Workload`, `.Fixture.Facts`, `.Fixture.Oracle`, with unit tests. Knobs, store and telemetry fixtures, deterministic UUIDv7-shaped workload generation, and typed JSON ledger facts exist. The unit suite checks handler arm selection, workload determinism and payload size, fact round trips, unique scenario IDs and registry validation. The SQL oracle and expanded mapping tests remain.
