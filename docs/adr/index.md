...
- [Distinguish documented limitations from known defects](0014-distinguish-documented-limitations-from-known-defects.md) - Verification distinguishes documented limitations from known defects and links confirmed runtime failures to reproducible owner-repository bug reports.
- [Own the shared keiro fixture in kenshou-keiro](0015-own-the-shared-keiro-fixture-in-kenshou-keiro.md) - The kenshou-keiro layer owns the ledger aggregate, workload, and independent oracles consumed by later Keiro runtime verification plans.
- [Park keiro workers at durable crash windows](0016-park-keiro-workers-at-durable-crash-windows.md) - Keiro crash scenarios park a worker inside append, acknowledgement, or projection hooks before externally terminating the process or backend.
